...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'NGSUtils'):
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['NGSUtils.fastqutils_stats_async'] = ['NGSUtils', 'fastqutils_stats']
async_check_methods['NGSUtils.fastqutils_stats_check'] = ['NGSUtils', 'fastqutils_stats']
sync_methods['NGSUtils.fastqutils_stats'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'NGSUtils'
        ...
        self.rpc_service.add(impl_NGSUtils.fastqutils_stats,
                             name='NGSUtils.fastqutils_stats',
                             types=[dict])
        self.method_authentication['NGSUtils.fastqutils_stats'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "NGSUtils but no authentication header was passed"
                            raise err
