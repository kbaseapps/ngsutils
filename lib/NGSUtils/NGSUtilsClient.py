...
class NGSUtils(object):
    ...
    def fastqutils_stats(self, params, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method fastqutils_stats: argument json_rpc_context is not type dict as required.')
        resp = self._call('NGSUtils.fastqutils_stats',
