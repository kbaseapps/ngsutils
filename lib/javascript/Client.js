...
function NGSUtils(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.fastqutils_stats = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "NGSUtils.fastqutils_stats",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "NGSUtils.status",
